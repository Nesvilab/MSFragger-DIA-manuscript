...
# plot a
diann_path = r"G:\Dropbox\papers_Fengchao\msfragger_dia\script\results\2018-HeLa\diann\modified_sequence_maxlfq.tsv"
maxdia_path = r"G:\Dropbox\papers_Fengchao\msfragger_dia\script\results\2018-HeLa\maxdia\combined\txt\modificationSpecificPeptides.txt"
msfraggerdia_path = r"G:\Dropbox\papers_Fengchao\msfragger_dia\script\results\2018-HeLa\msfraggerdia\modified_sequence_maxlfq.tsv"

diann = pd.read_csv(diann_path, sep="\t", index_col=0, na_values=[0, "", "NA"], header=0, usecols=["Unnamed: 0", "23aug2017_hela_serum_timecourse_pool_wide_001", "23aug2017_hela_serum_timecourse_pool_wide_002", "23aug2017_hela_serum_timecourse_pool_wide_003"])
...
msfraggerdia = pd.read_csv(msfraggerdia_path, sep="\t", index_col=0, na_values=[0, "", "NA"], header=0, usecols=["Unnamed: 0", "23aug2017_hela_serum_timecourse_pool_wide_001", "23aug2017_hela_serum_timecourse_pool_wide_002", "23aug2017_hela_serum_timecourse_pool_wide_003"])
...
sns_plot.set(xlabel=None, ylabel="coefficient of variation (%)")
sns_plot.figure.savefig("2018-HeLa_b_S.pdf")
